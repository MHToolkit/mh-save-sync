...
public sealed class ConverterCopy : ObservableObject
{
    ...
    public string NavigationConvert => Text(nameof(NavigationConvert));
    public string NavigationHistory => Text(nameof(NavigationHistory));
    public string NavigationExperimentalCec => Text(nameof(NavigationExperimentalCec));
    public string NavigationSettings => Text(nameof(NavigationSettings));
    public string InputPageTitle => Text(nameof(InputPageTitle));
    public string InputPageDescription => Text(nameof(InputPageDescription));
    public string OptionalPageTitle => Text(nameof(OptionalPageTitle));
    public string OptionalPageDescription => Text(nameof(OptionalPageDescription));
    public string DryRunPageTitle => Text(nameof(DryRunPageTitle));
    public string WriteResultPageTitle => Text(nameof(WriteResultPageTitle));
    public string HistoryPageTitle => Text(nameof(HistoryPageTitle));
    public string SettingsPageTitle => Text(nameof(SettingsPageTitle));
    public string StepOne => Text(nameof(StepOne));
    public string StepTwo => Text(nameof(StepTwo));
    public string StepThree => Text(nameof(StepThree));
    public string StepFour => Text(nameof(StepFour));
    public string ContinueToOptional => Text(nameof(ContinueToOptional));
    public string ContinueToDryRun => Text(nameof(ContinueToDryRun));
    public string SkipOptionalData => Text(nameof(SkipOptionalData));
    public string OptionalCoreUnaffected => Text(nameof(OptionalCoreUnaffected));
    public string InputMissingReason => Text(nameof(InputMissingReason));
    public string DryRunNeedsInspect => Text(nameof(DryRunNeedsInspect));
    public string DryRunReadyMessage => Text(nameof(DryRunReadyMessage));
    public string WriteAuthorizedMessage => Text(nameof(WriteAuthorizedMessage));
    public string HistoryEmptyTitle => Text(nameof(HistoryEmptyTitle));
    public string HistoryEmptyDescription => Text(nameof(HistoryEmptyDescription));
    public string StartConversion => Text(nameof(StartConversion));
    public string AdvancedDetails => Text(nameof(AdvancedDetails));
    public string OptionalMissingReason => Text(nameof(OptionalMissingReason));
    public string ChoosePaths => Text(nameof(ChoosePaths));
    public string SyntheticFixtureNotice => Text(nameof(SyntheticFixtureNotice));
    ...
    public string CurrentSlotHint => Text(nameof(CurrentSlotHint));
    public string TargetSlot => Text(nameof(TargetSlot));
    public string TargetSlotHint => Text(nameof(TargetSlotHint));
    public string RepairOutputSlot => Text(nameof(RepairOutputSlot));
    public string RepairOutputSlotHint => Text(nameof(RepairOutputSlotHint));
    public string NewOutputPlaceholder => Text(nameof(NewOutputPlaceholder));
    public string RepairOutputPlaceholder => Text(nameof(RepairOutputPlaceholder));
    ...
    public string DescribeResolvedCurrent(string path) => string.Format(Text("ResolvedCurrent"), path);
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        [nameof(Close)] = "Close",
        [nameof(NavigationConvert)] = "Convert save",
        [nameof(NavigationHistory)] = "History",
        [nameof(NavigationExperimentalCec)] = "Experimental CEC",
        [nameof(NavigationSettings)] = "Settings",
        [nameof(InputPageTitle)] = "Input & inspection",
        [nameof(InputPageDescription)] = "Choose the exact files for this conversion. Nothing is scanned or written automatically.",
        [nameof(OptionalPageTitle)] = "Optional data",
        [nameof(OptionalPageDescription)] = "System and ExtData are separate transactions. Leave them off or skip this step to continue with the core save only.",
        [nameof(DryRunPageTitle)] = "Dry Run",
        [nameof(WriteResultPageTitle)] = "Write & result",
        [nameof(HistoryPageTitle)] = "History",
        [nameof(SettingsPageTitle)] = "Settings",
        [nameof(StepOne)] = "Step 1 of 4",
        [nameof(StepTwo)] = "Step 2 of 4",
        [nameof(StepThree)] = "Step 3 of 4",
        [nameof(StepFour)] = "Step 4 of 4",
        [nameof(ContinueToOptional)] = "Continue to optional data",
        [nameof(ContinueToDryRun)] = "Continue to Dry Run",
        [nameof(SkipOptionalData)] = "Skip optional data",
        [nameof(OptionalCoreUnaffected)] = "Optional paths affect only their own component; they never block the core save workflow.",
        [nameof(InputMissingReason)] = "Choose a 3DS source and output before inspecting.",
        [nameof(DryRunNeedsInspect)] = "Inspect the required core inputs first.",
        [nameof(DryRunReadyMessage)] = "The inspected source, current reference, and output intent are ready for a read-only preview.",
        [nameof(WriteAuthorizedMessage)] = "Dry Run authorized these exact files. A final confirmation is still required before writing.",
        [nameof(HistoryEmptyTitle)] = "No transactions in this app session",
        [nameof(HistoryEmptyDescription)] = "Start with an explicit source and output. The app never scans for saves automatically.",
        [nameof(StartConversion)] = "Start conversion",
        [nameof(AdvancedDetails)] = "Technical details",
        [nameof(OptionalMissingReason)] = "One or more enabled optional components still need paths.",
        [nameof(ChoosePaths)] = "Choose paths",
        [nameof(SyntheticFixtureNotice)] = "Synthetic UI fixture — no files or converter commands are used.",
        ...
        [nameof(CurrentSlotHint)] = "Required only for repair. Choose the converted, same-slot user# you continued playing, or its direct parent folder. This input is never written.",
        [nameof(TargetSlot)] = "Wii U / Cemu output",
        [nameof(TargetSlotHint)] = "Choose an output user# file or folder. A folder becomes <folder>/<selected user#>; nothing is created until Write.",
        [nameof(RepairOutputSlot)] = "Repaired Wii U / Cemu output",
        [nameof(RepairOutputSlotHint)] = "Choose where to write the repaired result. This control is independent from the current Wii U reference; explicitly selecting the same path performs an in-place repair. Existing output is backed up; a missing user# is created only during Write. Guild-card repair requires an initialized output directory containing card1/card2/card3/cardbox.",
        [nameof(NewOutputPlaceholder)] = "output user# or folder",
        [nameof(RepairOutputPlaceholder)] = "repaired user# or output folder",
        ...
        [nameof(DryRunGate)] = "A successful repair Dry Run independently binds the original 3DS input, current Wii U reference, output state, and exact merge preview.",
        ...
        [nameof(WriteUnavailable)] = "Inspect every required input and output path, then complete a current Dry Run before writing.",
        [nameof(TransactionDetails)] = "Transaction scope",
        [nameof(BackupAndManifest)] = "Backups and manifests cover only the explicitly selected output scope.",
        [nameof(OneTarget)] = "Explicit output scope only",
        ...
        [nameof(ConfirmWriteBody)] = "This writes only the selected output after final source, current-reference, output-state, and preview checks. The Rust CLI creates transaction backups and a manifest; the current Wii U reference remains unchanged.",
        ...
        [nameof(FileChangedAfterDryRun)] = "A source, current Wii U reference, or output state changed after Dry Run. Inspect and run Dry Run again before writing.",
        ...
        ["ResolvedCurrent"] = "Read-only current Wii U input: {0}",
        ...
        ["PathError_MissingCurrentSelection"] = "Choose the current Wii U / Cemu reference save or its direct folder first.",
        ...
        ["PathError_CurrentPathMissing"] = "The selected current Wii U / Cemu user# is no longer available.",
        ["PathError_CurrentSlotMissing"] = "The selected current Wii U / Cemu folder does not directly contain the selected user#.",
        ["PathError_CurrentSlotNameMismatch"] = "The selected current Wii U / Cemu file does not match the selected user# slot.",
    ...
    private static readonly IReadOnlyDictionary<string, string> Chinese = new Dictionary<string, string>
    {
        ...
        [nameof(Close)] = "关闭",
        [nameof(NavigationConvert)] = "转换存档",
        [nameof(NavigationHistory)] = "历史记录",
        [nameof(NavigationExperimentalCec)] = "实验性 CEC",
        [nameof(NavigationSettings)] = "设置",
        [nameof(InputPageTitle)] = "输入与检查",
        [nameof(InputPageDescription)] = "为本次转换明确选择文件；应用不会自动扫描，也不会自动写入。",
        [nameof(OptionalPageTitle)] = "可选数据",
        [nameof(OptionalPageDescription)] = "system 与 ExtData 是独立事务；保持关闭或跳过后，可以只继续核心存档。",
        [nameof(DryRunPageTitle)] = "Dry Run",
        [nameof(WriteResultPageTitle)] = "写入与结果",
        [nameof(HistoryPageTitle)] = "历史记录",
        [nameof(SettingsPageTitle)] = "设置",
        [nameof(StepOne)] = "第 1 步，共 4 步",
        [nameof(StepTwo)] = "第 2 步，共 4 步",
        [nameof(StepThree)] = "第 3 步，共 4 步",
        [nameof(StepFour)] = "第 4 步，共 4 步",
        [nameof(ContinueToOptional)] = "继续配置可选数据",
        [nameof(ContinueToDryRun)] = "继续 Dry Run",
        [nameof(SkipOptionalData)] = "跳过可选数据",
        [nameof(OptionalCoreUnaffected)] = "可选路径只影响对应组件，绝不会阻塞核心存档流程。",
        [nameof(InputMissingReason)] = "请先选择 3DS 源存档和输出位置。",
        [nameof(DryRunNeedsInspect)] = "请先检查全部必需的核心输入。",
        [nameof(DryRunReadyMessage)] = "源存档、当前引用和输出意图已经检查，可以进行只读预览。",
        [nameof(WriteAuthorizedMessage)] = "Dry Run 已授权这些准确文件；真正写入前仍需最终确认。",
        [nameof(HistoryEmptyTitle)] = "本次会话暂无事务",
        [nameof(HistoryEmptyDescription)] = "请从明确的源和输出位置开始，应用不会自动扫描存档。",
        [nameof(StartConversion)] = "开始转换",
        [nameof(AdvancedDetails)] = "技术细节",
        [nameof(OptionalMissingReason)] = "一个或多个已启用的可选组件仍缺少路径。",
        [nameof(ChoosePaths)] = "选择路径",
        [nameof(SyntheticFixtureNotice)] = "合成 UI fixture：不会读取文件，也不会运行转换器命令。",
        ...
        [nameof(ConversionModeRepairDescription)] = "修复模式使用三个明确路径：原始 3DS user#、继续游玩后的最新同槽位 Wii U / Cemu user#，以及独立输出位置。当前 Wii U 存档只读引用，只有输出位置会被写入。还要修复收到的公会名片和离线伙伴时，请在下方启用“公会名片与离线伙伴”，并选择原始 3DS ExtData user 目录。",
        ...
        [nameof(CurrentSlotHint)] = "仅修复模式必选。请选择之前转换过、后来继续游玩的同槽位 user#，或直接包含它的目录。该输入始终只读，不会被写入。",
        [nameof(TargetSlot)] = "Wii U / Cemu 输出位置",
        [nameof(TargetSlotHint)] = "选择输出 user# 文件或目录。目录会解析为 <目录>/<所选 user#>；只有写入时才会创建文件。",
        [nameof(RepairOutputSlot)] = "修复后的 Wii U / Cemu 输出位置",
        [nameof(RepairOutputSlotHint)] = "请选择修复结果的写入位置，该控件与当前 Wii U 引用存档相互独立；若明确选择同一路径则执行原地修复。已有输出会先备份；不存在的 user# 只在正式写入时创建。若同时修复公会名片，输出目录必须已初始化并包含 card1/card2/card3/cardbox。",
        [nameof(NewOutputPlaceholder)] = "输出 user# 或目录",
        [nameof(RepairOutputPlaceholder)] = "修复输出 user# 或目录",
        ...
        [nameof(DryRunGate)] = "修复模式的成功 Dry Run 会分别绑定原始 3DS 输入、当前 Wii U 引用、输出状态和准确的合并预览。",
        ...
        [nameof(WriteUnavailable)] = "请先检查全部必需输入与输出路径，并完成当前有效的 Dry Run。",
        [nameof(TransactionDetails)] = "事务范围",
        [nameof(BackupAndManifest)] = "备份和 manifest 只覆盖用户明确选择的输出范围。",
        [nameof(OneTarget)] = "仅明确选择的输出范围",
        ...
        [nameof(ConfirmWriteBody)] = "最终检查原始源、当前 Wii U 引用、输出状态和预览后，只会写入所选输出。Rust CLI 会创建事务备份和 manifest；当前 Wii U 引用保持不变。",
        ...
        [nameof(FileChangedAfterDryRun)] = "Dry Run 后原始源、当前 Wii U 引用或输出状态发生变化。写入前请重新检查并运行 Dry Run。",
        ...
        ["ResolvedCurrent"] = "只读引用的当前 Wii U 存档：{0}",
        ...
        ["PathError_MissingCurrentSelection"] = "请先选择当前 Wii U / Cemu 引用存档或其直接目录。",
        ...
        ["PathError_CurrentPathMissing"] = "所选当前 Wii U / Cemu user# 已经不可用。",
        ["PathError_CurrentSlotMissing"] = "所选当前 Wii U / Cemu 目录不直接包含当前 user#。",
        ["PathError_CurrentSlotNameMismatch"] = "所选当前 Wii U / Cemu 文件与当前 user# 槽位不匹配。",
