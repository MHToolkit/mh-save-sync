...
public sealed class ConverterCopy : ObservableObject
{
    ...
    private static readonly IReadOnlyDictionary<string, string> English = new Dictionary<string, string>
    {
        ...
        [nameof(ExtDataNotice)] = "ExtData is optional. Choose its exact user directory (or only its direct 00000481 parent); each optional transaction has its own Dry Run and manifest.",
    ...
    private static readonly IReadOnlyDictionary<string, string> Chinese = new Dictionary<string, string>
    {
        ...
        [nameof(ExtDataNotice)] = "ExtData 是可选项。请选择准确的 user 目录（或它的直接 00000481 父目录）；每个可选事务都有独立的 Dry Run 和 manifest。",
