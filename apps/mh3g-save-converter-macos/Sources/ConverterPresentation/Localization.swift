...
public enum ConverterCopy {
    private static let zhHans: [String: String] = [
        ...
        "Input.RepairHint": "已经转换并继续游玩？添加原始 3DS 存档和当前 Wii U/Cemu 存档。修复只更新仍保持旧版转换结果的字段。",
        ...
        "Status.Failed": "操作失败",
        "Status.Detail.NeedsInput": "明确选择 3DS 源角色文件与 Cemu 目标；应用不会自动扫描存档目录。",
        ...
        "Write.SystemFooter": "system 使用独立的源、目标与 SHA-256 授权。",
    ...
    private static let english: [String: String] = [
        ...
        "Input.RepairHint": "Already converted and kept playing? Add the original 3DS save and the current Wii U/Cemu save. Only fields that still match an older conversion are repaired.",
        ...
        "Status.Detail.NeedsInput": "Choose an explicit 3DS source slot and Cemu target. The app never scans save directories automatically.",
        ...
        "Write.SystemFooter": "System keeps its own source, target, and SHA-256 authorization.",
