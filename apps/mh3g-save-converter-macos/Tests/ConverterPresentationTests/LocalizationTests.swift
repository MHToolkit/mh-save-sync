...
final class LocalizationTests: XCTestCase {
    func testStringCatalogContainsChineseAndEnglish() throws {
        ...
        for key in [
            ...
            "Status.OptionalDataBlocked",
            "Status.SelectedWorkPending",
            "Status.Blocked",
            "Status.Authorized",
            "Status.Running",
            "Status.Succeeded",
            "Status.Failed",
            "Status.Detail.NeedsInput",
            "Status.Detail.NeedsInspection",
            "Status.Detail.ReadyForDryRun",
            "Status.Detail.RevisionRequired",
            "Status.Detail.OptionalDataBlocked",
            "Status.Detail.SelectedWorkPending",
            "Status.Detail.Authorized",
