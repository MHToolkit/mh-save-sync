...
- The menu-bar title now reflects onboarding progress (`MH 云存档 · 设服务器/选目录/选密钥/就绪`), and `--menu-preview` verifies that `同步路线`, `下一步`, manual upload and auto-sync entries are visible without launching the GUI.
